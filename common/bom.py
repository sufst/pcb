...
if "KICAD7_PLUGIN_DIR" in os.environ:
    pd = os.environ["KICAD7_PLUGIN_DIR"]
elif "KICAD7_SYMBOL_DIR" in os.environ:
    pd = os.environ["KICAD7_SYMBOL_DIR"] + "../plugins/"
else:
    print("Can't find suitable plugin directory")
    exit(1)
...
out.writerow(['Ref', 'Value', 'Footprint', 'Notes', 'Order Code', 'Supplier', 'Qty'])
...
for group in grouped:
    ...
    out.writerow([refs,
                  ...
                  fromNetlistText(c.getField("Notes")),
                  fromNetlistText(c.getField("Order Code")),
